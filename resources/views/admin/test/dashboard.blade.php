...
{{--
    ...
    <div class="flex">
        <div class="flex-1 p-6 sm:px-3 lg:mx-6 sm:mx-4 bg-gray-400 h-full">
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Corrupti in cum voluptatem ullam quod vel incidunt voluptatum molestiae debitis nobis earum quae, sint laborum, quia suscipit impedit laudantium vitae itaque asperiores magni laboriosam ipsam. Vitae deserunt ut reiciendis nam eaque beatae molestiae placeat repellendus exercitationem, laboriosam, velit culpa quo similique?</p>
        </div>
        <div class="flex-1 p-6 sm:px-3 lg:mx-6 sm:mx-4 bg-green-100 h-full">
        </div>
    </div>
